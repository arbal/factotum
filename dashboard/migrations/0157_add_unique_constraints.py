...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            ...
            options={'verbose_name': 'Extracted Habits and Practices/PUC Association',
                     'verbose_name_plural': 'Extracted Habits and Practices/PUC Associations'},
        ),
        migrations.AlterModelOptions(
            name='productdocument',
            options={'verbose_name': 'Product/Document Association',
        ...
        migrations.AlterModelOptions(
            name='taxonomytopuc',
            options={'verbose_name': 'Taxonomy/PUC Association', 'verbose_name_plural': 'Taxonomy/PUC Associations'},
        ),
        migrations.AlterModelOptions(
            name='producttotag',
            options={'verbose_name': 'Product/PUC Association', 'verbose_name_plural': 'Product/PUC Associations'},
        ),
