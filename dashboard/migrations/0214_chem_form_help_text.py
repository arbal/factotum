# Generated by Django 2.2.20 on 2021-11-04 14:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='extractedcomposition',
            name='unit_type',
            field=models.ForeignKey(blank=True, help_text='The unit type for the concentration, as reported in source document.', null=True, on_delete=django.db.models.deletion.PROTECT, to='dashboard.UnitType', verbose_name='Unit Type'),
        ),
        migrations.AlterField(
            model_name='extractedcomposition',
            name='weight_fraction_type',
            field=models.ForeignKey(default='1', help_text='Reported (Default) refers to weight fractions calculated using composition data present on the source document, while Predicted values are generated via model.', null=True, on_delete=django.db.models.deletion.PROTECT, to='dashboard.WeightFractionType', verbose_name='Weight Fraction Type'),
        ),
        migrations.AlterField(
