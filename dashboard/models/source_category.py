...
class SourceCategory(CommonInfo):
    ...
    source_id = models.CharField(max_length=255, blank=True, help_text="source ID")
    source_parent_id = models.CharField(
        max_length=255, blank=True, help_text="source parent ID"
    )
    path = models.CharField(max_length=255, blank=True, help_text="path")
